...
from laozhubot.plugins.setu.config import DATA_PATH, config
from laozhubot.plugins.setu.setu_massage import setu_sendcd
...
class PermissionManager:
    ...
    def check_permission(
        ...
        # 采用白名单检查, 如果白名单被禁用则跳过
        if not self.setu_disable_wlist and (user_type == "group" or ((not self.setu_enable_private) and user_type == "private")) and session_id not in self.cfg.keys():
